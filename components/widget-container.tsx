...
export function WidgetContainer({ id, type, onRemove, size, position, onResize, onMove }: WidgetContainerProps) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs text-muted-foreground flex-1">Widget: {id}</span>
        <button
          onClick={() => onRemove(id)}
